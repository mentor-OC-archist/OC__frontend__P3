...
### III) RESSOURCES MENTOR: 
   ...
   - [P3: ESLint](https://marketplace.visualstudio.com/items?itemName=dbaeumer.vscode-eslint)
    ...
    ###### console log: 
       - [P3: wrap console log](https://marketplace.visualstudio.com/items?itemName=midnightsyntax.vscode-wrap-console-log)
       - [P3: Turbo Console Log](https://marketplace.visualstudio.com/items?itemName=ChakrounAnas.turbo-console-log)
    ###### JSON: 
       - [JSON Formatter](https://chrome.google.com/webstore/detail/json-formatter/bcjindcccaagfpapjjmafapmmgkkhgoa?hl=en)
    ###### snippets: 
       - [P3: ES snippets](https://marketplace.visualstudio.com/items?itemName=kingxbeta.v-snippets)
       - [P3: ES7+ React/Redux/React-Native snippets](https://marketplace.visualstudio.com/items?itemName=dsznajder.es7-react-js-snippets)
...
## MISSION: 
<div class="projects-0-projects23 projects-0-projects90"><div class="projects-0-projects92"><span class="sc-bczRLJ gOMWEI MuiTypography-root MuiTypography-body2 projects-0-projects100 projects-0-projects96  projects-0-projects102"><svg class="sc-fEOsli ciCWDI MuiSvgIcon-root MuiSvgIcon-fontSizeMedium projects-0-projects99 projects-0-projects97" focusable="false" role="img" viewBox="0 0 24 24" data-testid="QueryBuilderIcon"><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"></path><path d="M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"></path><title>Durée</title></svg><span class="projects-0-projects101 projects-0-projects98"><span class="projects-0-projects95">60 heures</span></span></span><span class="sc-bczRLJ jXMTOB MuiTypography-root MuiTypography-caption"><span>Mis à jour le mardi 27 septembre 2022</span></span></div><div class="oc-richContent root-0-3-1" data-videotitle="video" data-current-user-id="8394768" data-project-id="1157" data-codio-button-label="Accéder au code"><aside data-claire-semantic="information">
<p>Avant<strong>&nbsp;de démarrer votre travail sur ce projet, nous vous conseillons de&nbsp;:</strong></p>
<ol>
<li>Lire le scénario en entier, chaque section du projet ainsi que les documents fournis.&nbsp;</li>
<li>Consulter <a href="https://course.oc-static.com/projects/D%C3%A9veloppeur+Web/IW_P6+JS+page+dynamique/E%CC%81tapes+cle%CC%81s+P6+Front-End+(3).pdf">le&nbsp;guide des étapes clés</a> contenant des recommandations et des ressources pour organiser votre travail.</li>
<li>Préparer une liste de questions pour votre première session de mentorat.</li>
</ol>
</aside>
<p>&nbsp;</p>
<p><img src="https://user.oc-static.com/upload/2022/06/23/16559727182885_DEV_scenario.png" alt="Scénario"></p>
<p>Vous travaillez comme développeur front-end pour l’agence ArchiWebos qui comprend 50&nbsp;salariés.&nbsp;</p>
<p>Ayant terminé votre dernier projet avec un peu d'avance, vous êtes envoyé en renfort comme développeur front-end d’une équipe qui travaille sur la conception du site portfolio d’une architecte d’intérieur.</p>
<p>Nous sommes lundi matin et c’est l’heure de votre premier brief d’équipe pour ce projet.</p>
<p>Vous savez que vous allez recevoir beaucoup d’informations, vous vous préparez donc à prendre des notes.<br><br></p>
<div class="oc-video"><iframe class="oc-video__iframe" src="https://player.vimeo.com/video/733231431?color=7451eb" allowfullscreen=""></iframe></div>
<p>&nbsp;</p>
<p><img src="https://user.oc-static.com/upload/2022/06/24/16560895064552_DEV_deux-semaines-plus-tard.png" alt="Quelques secondes plus tard"></p>
